  ...
  const renderPage = () => {
    const pageComponent = (() => {
      switch (currentPage) {
        ...
        case 8: return <Page09BodyType audio={audio} />; // tipo_de_corpo
        case 9: return <Page10DailyRoutine audio={audio} />; // rotina_diaria
        case 10: return <Page11WeightLossBarriers audio={audio} />; // barreiras
        ...
        case 14: return <Page08NameInput audio={audio} />; // nome
